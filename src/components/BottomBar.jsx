    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 p-2 bg-dark-950/95 backdrop-blur-xl border-t border-dark-800 shadow-[0_-10px_25px_rgba(0,0,0,0.8)]">
      <div className="max-w-md mx-auto grid grid-cols-4 gap-2 items-center">
        ...
        <button
          ...
          className="py-2 px-2 rounded-xl flex flex-col items-center justify-center gap-1 transition-all cursor-pointer text-neutral-400 hover:text-white hover:bg-dark-900"
        ...
        >
          ...
          <span className="text-[10px] tracking-tight truncate max-w-[60px] font-medium">
        ...
        <a
          ...
          className="py-2 px-2 rounded-xl flex flex-col items-center justify-center gap-1 text-emerald-400 hover:text-emerald-300 hover:bg-dark-900 transition-all"
        ...
        <button
          ...
          className="py-2 px-2 rounded-xl theme-gradient-accent text-dark-950 font-black flex flex-col items-center justify-center gap-0.5 theme-shadow-glow active:scale-[0.96] transition-all cursor-pointer shadow-lg"
